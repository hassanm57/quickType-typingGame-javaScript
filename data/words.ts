// ~400 common English words used for random test generation
const WORDS: string[] = [
  ...
  "often", "hand", "high", "place", "hold", "turn", "was", "where", "much",
  "help", "through", "before", "line", "right", "too", "mean", "old",
  "any", "same", "tell", "boy", "follow", "came", "want", "show", "also",
  "around", "form", "small", "set", "put", "end", "does", "another",
  "well", "large", "need", "big", "such", "even", "long", "thing", "man",
  "seems", "knew", "play", "spell", "air", "away", "animal", "house",
  "point", "page", "letter", "mother", "answer", "found", "study", "still",
  "learn", "plant", "cover", "food", "sun", "four", "between", "state",
  "keep", "eye", "never", "last", "door", "let", "thought", "city",
  ...
  "next", "white", "children", "began", "got", "walk", "example", "ease",
  ...
  "space", "heard", "best", "hour", "better", "during", "hundred", "five",
  ...
  "heart", "present", "heavy", "dance", "engine", "position", "arm",
  ...
  "energy", "hunt", "probable", "bed", "brother", "egg", "ride",
  "cell", "believe", "fraction", "forest", "sit", "race", "window",
  "store", "summer", "train", "sleep", "prove", "lone", "leg",
  "exercise", "wall", "catch", "mount", "wish", "sky", "board",
